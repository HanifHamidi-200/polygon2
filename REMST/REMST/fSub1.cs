...
namespace REMST
{
    public partial class fSub1 : Form
    {
        ...
        private int nNumber;
        private int mnSitCol, mnSitRow, mnCol, mnRow;
        private int mnSittype, mnSitrotate;

        private void fReset()
        {
            Random rnd1 = new Random();
            int nCrater = rnd1.Next(8, 17);
            int nGun = rnd1.Next(4, 9);
            int nCol = 0, nRow = 0;
            ...
            for (int i = 1; i <= nCrater; i++)
            {
                fFree(ref nCol, ref nRow);
                fPlace(nCol, nRow, 8);
            }
            for (int i = 1; i <= nGun; i++)
            {
                fFree(ref nCol, ref nRow);
                fPlace(nCol, nRow, 9);
            }

            mnSitCol = rnd1.Next(1, 9);
            mnSitRow = rnd1.Next(1, 9);
        ...
        private void fUpdateYOU()
        {
            ...
            int nType=mnSittype, nRotate = mnSitrotate;
