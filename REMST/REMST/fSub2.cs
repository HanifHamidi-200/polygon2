...
namespace REMST
{
    public partial class fSub2 : Form
    {
        ...
        private void fSposm(ref int nCol,ref int nRow)
        {
        ...
        private void fReset()
        {
            ...
            nCol = rnd1.Next(1, 9);
            nRow = rnd1.Next(1, 9);
            for (int i = 1; i <= nMethanesea; i++)
            {
                nLength = rnd1.Next(6, 21);
                for (int j = 1; j <= nLength; j++)
                {
                    fSposm(ref nCol, ref nRow);
                }
            }
